            ...
            <div class="page-body clearfix">
                <div class="row">
                    <div class="col-md-offset-1 col-md-10">
                        <div class="panel-heading"><h3>Today Details </h3></div>
                        <a  href="addUser.php";><button class="bttn bttn_center">New Info </button></a>
                        ...
                        <table class= "table table-dark">
                            ...
                            $sql= "SELECT id, username, password FROM user WHERE created_at LIKE '$cDate%'";
