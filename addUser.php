                                                ...
                                                <div class="fields ">
                                                    <div class="form-group  field-username">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <input class="form-control" maxlength="255" name="username" type="text" value="" required/>
                                                    ...
                                                    <div class="form-group  field-passwd">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="col-sm-8">
                                                                ...
                                                                <input class="form-control" maxlength="255" name="password" type="text" value="" required/>
                                                            </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <label for="id_is_active" class="vCheckboxLabel">Is active</label>
                                                                    ...
                                                                    <input  name="id_is_active" type="checkbox"/>
